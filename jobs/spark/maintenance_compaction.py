...
TABLES = [
    "rest.silver.item_sales_spark",
    "rest.silver.item_sales_flink",
    "rest.silver.item_attributes_spark",
    "rest.silver.item_attributes_flink",
    "rest.silver.item_attributes_flink_v2",
    "rest.bronze.item_sales_spark",
    "rest.bronze.item_sales_flink",
    "rest.bronze.item_attributes_spark",
    "rest.bronze.item_attributes_flink",
    "rest.gold.item_category_count_spark",
    "rest.gold.item_category_count_flink",
    "rest.gold.item_category_count_flink_v2",
]
