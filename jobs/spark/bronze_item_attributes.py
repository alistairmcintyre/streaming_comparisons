"""
Spark Structured Streaming: Kafka → bronze.item_attributes_spark
"""
...
CHECKPOINT_PATH = f"{CHECKPOINT_BASE}/bronze_item_attributes_spark"
...
def main():
    spark = (
        ...
        .appName("bronze-item-attributes-spark")
        .getOrCreate()
    )
    ...
    raw = (
        ...
        .option("kafka.group.id", "spark-bronze-attr")
        .load()
    ...
    query = (
        ...
        .format("iceberg")
        .outputMode("append")
        .option("path", "rest.bronze.item_attributes_spark")
