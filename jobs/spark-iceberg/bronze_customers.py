"""
Spark Structured Streaming: Kafka → bronze.customers_spark
"""
...
CHECKPOINT_PATH = f"{CHECKPOINT_BASE}/bronze_customers_spark"
...
def main():
    spark = (
        ...
        .appName("bronze-customers-spark")
        .getOrCreate()
    )
    ...
    raw = (
        ...
        .option("kafka.group.id", "spark-bronze-customers")
        .load()
    ...
    query = (
        ...
        .format("iceberg")
        .outputMode("append")
        .option("path", "rest.bronze.customers_spark")
