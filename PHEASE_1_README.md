...
```sql
-- Step 1: INSERT
INSERT INTO customers (customer_id, name, country, segment) VALUES (11, 'K', 'IE', 'premier');

UPDATE customers SET country = 'US' WHERE customer_id = 1;   -- moves a GB customer to US  
                                                                                                                              
DELETE FROM customers WHERE customer_id = 5;                 -- GDPR erasure
...
FROM rest.silver.customers_flink.snapshots
